            ...
            <div className="container mt-5" style={{backgroundColor:blur}}>
                ...
                <form onSubmit={handleSubmit} className="mt-4">
                    ...
                    <div className="form-group">
                        ...
                        <input type="checkbox" name="hobby" value="Code" checked={hobby.includes('Code')} onChange={handleInput} /> gaming
                        <input type="checkbox" name="hobby" value="Paint" checked={hobby.includes('Paint')} onChange={handleInput} /> coading
                        <input type="checkbox" name="hobby" value="Paint" checked={hobby.includes('Paint')} onChange={handleInput} /> reading
                    </div>
                    <div className="form-group">
                        <label>City</label>
